  ...
  return (
    <View className="flex-1 bg-white">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-row gap-3">
            ...
            <View className="flex-1">
              <LinearGradient
                ...
                <Text className="mb-1 text-3xl font-bold text-white">{userData?.streak || 0}</Text>
        ...
        {/* Focus Hours Chart */}
        <View className="mb-6 px-6">
          <Text className="mb-3 text-base font-bold text-slate-900">Focus Hours This Week</Text>
        ...
        {/* XP Progress Chart */}
        <View className="mb-6 px-6">
          <Text className="mb-3 text-base font-bold text-slate-900">XP Earned This Week</Text>
          <View className="rounded-2xl bg-slate-50 p-4">
            <BarChart
              data={xpData}
              width={screenWidth - 80}
        ...
        <View className="mb-6 px-6">
          ...
          {userData?.badges && userData.badges.length > 0 ? (
            userData.badges.slice(0, 3).map((badge: any, index: number) => (
              <View key={index} className="mb-3 flex-row items-center rounded-2xl bg-slate-50 p-4">
